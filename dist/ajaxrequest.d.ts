...
declare interface CallbackContext {
    ...
    /** Parsed XML response string, or null if response is not XML. */
...
/**
 * Object returned when resolving/rejecting the Promise from send().
 */
...
declare class AJAXRequest {
     ...
     * @returns A Promise that resolves on 2xx/3xx or rejects on 4xx/5xx/disconnected.
     */
